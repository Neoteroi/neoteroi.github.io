...
| APP_FORCE_HTTPS               | Settings | If "1" or "true", automatically configures the application to set HSTS response headers and use `https` scheme. See [_Behind Proxies_](./behind-proxies.md).                                                                                                                                                |
| APP_HTTP_SCHEME               | Settings | Allows to configure the request scheme. See [_Behind Proxies_](./behind-proxies.md).                                                                                                                                                                                                                        |
...
| APP_OPENAPI_PROGRAMMING_NAMES | Settings | If "1" or "true", uses underscores to document generic types like in: `list[Address]` -> `list_Address` in the OpenAPI documentation file.                                                                                                                                                                  |
